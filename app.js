...
const WC_TEAMS = [
  ...
  { name: 'Bahrain',      flag: '🇧🇭', color: '#CE1126' },
  { name: 'Belgium',      flag: '🇧🇪', color: '#ED1C24' },
  { name: 'Bolivia',      flag: '🇧🇴', color: '#2E9D4E' },
  ...
  { name: 'Costa Rica',   flag: '🇨🇷', color: '#AC1E2D' },
  { name: 'Croatia',      flag: '🇭🇷', color: '#E1261C' },
  { name: 'Cuba',         flag: '🇨🇺', color: '#CB1F2E' },
  ...
  { name: 'Guatemala',    flag: '🇬🇹', color: '#4FA3D1' },
  { name: 'Italy',        flag: '🇮🇹', color: '#0E72B5' },
  { name: 'Ivory Coast',  flag: '🇨🇮', color: '#FF8200' },
  { name: 'Japan',        flag: '🇯🇵', color: '#16348C' },
  { name: 'Malaysia',     flag: '🇲🇾', color: '#FDB913' },
  ...
  { name: 'Tanzania',     flag: '🇹🇿', color: '#1D62B3' },
  { name: 'Thailand',     flag: '🇹🇭', color: '#2B2D87' },
  { name: 'Togo',         flag: '🇹🇬', color: '#006A4E' },
