...
const WC_TEAMS = [
  ...
  { name: 'Canada',       flag: '🇨🇦' }, { name: 'Uruguay',      flag: '🇺🇾' },
  { name: 'Panama',       flag: '🇵🇦' }, { name: 'Bolivia',      flag: '🇧🇴' },
  { name: 'Spain',        flag: '🇪🇸' }, { name: 'Brazil',       flag: '🇧🇷' },
  { name: 'Japan',        flag: '🇯🇵' }, { name: 'Australia',    flag: '🇦🇺' },
  { name: 'Morocco',      flag: '🇲🇦' }, { name: 'Cameroon',     flag: '🇨🇲' },
  { name: 'Germany',      flag: '🇩🇪' }, { name: 'Portugal',     flag: '🇵🇹' },
  { name: 'Argentina',    flag: '🇦🇷' }, { name: 'France',       flag: '🇫🇷' },
  { name: 'Ecuador',      flag: '🇪🇨' }, { name: 'Venezuela',    flag: '🇻🇪' },
  { name: 'England',      flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿' }, { name: 'Netherlands',  flag: '🇳🇱' },
  { name: 'Colombia',     flag: '🇨🇴' }, { name: 'South Korea',  flag: '🇰🇷' },
  { name: 'Senegal',      flag: '🇸🇳' }, { name: 'Ivory Coast',  flag: '🇨🇮' },
  { name: 'Italy',        flag: '🇮🇹' }, { name: 'Croatia',      flag: '🇭🇷' },
  { name: 'Turkey',       flag: '🇹🇷' }, { name: 'Saudi Arabia', flag: '🇸🇦' },
  { name: 'Egypt',        flag: '🇪🇬' }, { name: 'New Zealand',  flag: '🇳🇿' },
  { name: 'Belgium',      flag: '🇧🇪' }, { name: 'Serbia',       flag: '🇷🇸' },
  { name: 'Poland',       flag: '🇵🇱' }, { name: 'Togo',         flag: '🇹🇬' },
  { name: 'Thailand',     flag: '🇹🇭' }, { name: 'Philippines',  flag: '🇵🇭' },
  { name: 'Switzerland',  flag: '🇨🇭' }, { name: 'Chile',        flag: '🇨🇱' },
  { name: 'Costa Rica',   flag: '🇨🇷' }, { name: 'Guatemala',    flag: '🇬🇹' },
  { name: 'South Africa', flag: '🇿🇦' }, { name: 'Tanzania',     flag: '🇹🇿' },
  { name: 'Denmark',      flag: '🇩🇰' }, { name: 'Sweden',       flag: '🇸🇪' },
  { name: 'Ukraine',      flag: '🇺🇦' }, { name: 'Bahrain',      flag: '🇧🇭' },
  { name: 'Malaysia',     flag: '🇲🇾' }, { name: 'Cuba',         flag: '🇨🇺' },
]
